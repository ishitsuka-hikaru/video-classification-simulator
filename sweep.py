...
def get_opts():
    ...
    p.add_argument('--floor_texture_path', type=str, default='none')
...
if __name__ == '__main__':
    ...
    theta = np.radians(90-opt.latitude)
    ...
    if opt.floor_texture_path != 'none':
        h.add_floor(opt.floor_texture_path)
